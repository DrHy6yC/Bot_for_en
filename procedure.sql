...
DELIMITER //
CREATE PROCEDURE set_user_in_bd(IN user_id INT, IN user_name VARCHAR(50), IN user_login_tg VARCHAR(30))
BEGIN
...
DELIMITER //
CREATE PROCEDURE get_const_db(IN const_name VARCHAR(25), OUT const_value VARCHAR(200))
BEGIN
...
DELIMITER //
CREATE PROCEDURE get_id_survey_db(IN survey_name VARCHAR(25), OUT id_survey INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE get_answer(IN num_question INT, IN id_survey INT)
BEGIN
...
DELIMITER //
CREATE PROCEDURE get_question(IN num_question INT, IN id_survey INT, OUT question_txt VARCHAR(200))
BEGIN
...
DELIMITER //
CREATE PROCEDURE get_one_answer(IN num_question INT, IN id_survey INT, IN num_answer INT,  OUT answer_txt VARCHAR(200))
BEGIN
